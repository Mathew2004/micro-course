...
*/
   ...
   $add_playlist->execute([$id, $tutor_id, $title, $description, $img, $status]);
...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="img" maxlength="500" required placeholder="enter img direct link" class="box">
