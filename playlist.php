...
-->
   <section class="courses">
      ...
      <div class="box-container">
         ...
         $select_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE  status = ? ");
      ...
      ?>
         <div class="box">
            <a href="search_playlist.php?get_id=<?= $fetch_playlist['id']; ?>">
               <!--
            <img src="uploaded_files/<?//= $fetch_playlist['thumb']; ?>" class="thumb" alt=""> -->
            <div class="thumb">
               <span><?= $total_videos; ?></span>
               <img src="<?= $fetch_playlist['thumb']; ?>" alt="">
            </div>
      ...
      <div class="row">
            ...
            <div class="col">
               ...
               <div class="details">
                  ...
                  <a href="search_playlist.php?get_id=<?//= $fetch_playlist['id']; ?>" class="btn" style="width: 200px">View Playlist</a>
               </div>
            </div>
         ...
         <?php
            ...
            echo "<p class='empty'>Comming Soon!</p>"; 
        } 
      ?>
